...
if __name__ == "__main__":
    ...
    model1 = spectre_model("model1", "deeplearning", True, 1000, 0.5, 1)
    model2 = spectre_model("model2", "deeplearning", True, 50, 0.2, 0.2)
    model_list = models()
    
    model_list.add_model(model1)
    model_list.add_model(model2)
    
    #model3 = model_list.get_model("model1")
    #print(model_list.list_models())
    
    #data = '''[{"__modelname__": "model1", "__modeltype__": "deeplearning", "__emissions__": 1000, "__bias__": 0.5, "__explained__": true, "__epsilon__": 1},
#{"__modelname__": "model2", "__modeltype__": "deeplearning", "__emissions__": 50, "__bias__": 0.2, "__explained__": true, "__epsilon__": 0.2}
#]'''
    
    data = model_list.rank_models()
    print(data)
